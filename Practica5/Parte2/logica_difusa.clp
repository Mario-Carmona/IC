...
; Nuevo valor de la función de pertenencia de la variable peso
(cd peso bajo 0 0 45 55)     ; aproximadamente  menos de 45
(cd peso medio 50 59 73 75)  ; aproximadamente entre 59 y 73
(cd peso alto 73 84 300 300) ; aproximadamente mas de 84

; Nueva variable
(cd edad baja 0 0 20 23)     ; aproximadamente  menos de 20
(cd edad media 21 25 48 52)  ; aproximadamente entre 25 y 48
(cd edad alta 50 56 150 150) ; aproximadamente mas de 56
...
(regla 6 antecedente temperatura media)
(regla 6 antecedente edad baja)
(regla 6 consecuente dosis baja)
(regla 6 explicacion "Si la temperatura es media y la edad es baja, la dosis a aplicar es baja")
(regla 7 antecedente peso medio)
(regla 7 antecedente edad baja)
(regla 7 consecuente dosis media)
(regla 7 explicacion "Si el peso es medio y la edad es baja, la dosis a aplicar es media")
)
